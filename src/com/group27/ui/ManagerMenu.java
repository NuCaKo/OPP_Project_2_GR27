...
public class ManagerMenu extends SeniorMenu {
     ...
     * Starts the menu with the DAO and the user who is presently logged in.
     *
    ...
    /**
     * Coordinates the process of adding a new user to the system.
     * <p>
     * Steps:
    ...
    /**
     * Coordinates the process of removing an existing user.
     * <p>
     * Steps:
     * 1. Requests User ID.
    ...
    /**
     * Shows a structured list of every system user.
    ...
    /**
     * A utility method to pose a Yes/No query to the user.
     *
